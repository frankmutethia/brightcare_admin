...
final slideList = [
  Slide(
    imageUrl:
        'https://assets6.lottiefiles.com/private_files/lf30_mec2ti4p.json ',
    title: 'Welcome to Bright Care Admin Panel.',
    description: 'We help you to keep going.',
  ),
  Slide(
    imageUrl: 'https://lottiefiles.com/34705-lock-cpu-cyber-security',
    title: 'Keep a positive state of mind.',
    description: 'Your security is our priority.',
  ),
  Slide(
    imageUrl: 'https://lottiefiles.com/41632-reloading ',
    title: 'Stay positive.',
